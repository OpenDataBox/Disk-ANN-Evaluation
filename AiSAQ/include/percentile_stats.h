...
struct QueryStats
{
    ...
    // Memory statistics
    size_t memory_usage_start = 0;  // Memory usage at query start (bytes)
    size_t memory_usage_end = 0;    // Memory usage at query end (bytes)
    size_t memory_usage_peak = 0;   // Peak memory usage during query (bytes)
    
    // Distance computation statistics
    unsigned n_pq_dists = 0;       // # of PQ distance computations
    unsigned n_exact_dists = 0;    // # of exact/full-precision distance computations
};
