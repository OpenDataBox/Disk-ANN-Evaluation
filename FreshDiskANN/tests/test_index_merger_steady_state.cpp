...
void search_disk_index(const std::string              &index_prefix_path,
  ...
  std::cout << std::setw(6) << "L" << std::setw(12) << "QPS" << std::setw(16)
            << "Mean Latency" << std::setw(16) << "90 Latency" << std::setw(16)
            << "95 Latency" << std::setw(16) << "99 Latency" << std::setw(16)
            << "99.9 Latency" << std::setw(16) << "Mean IOs" << std::setw(16)
            << recall_string << std::setw(16) << "CPU (s)" << std::endl;
  // prep for search
...
#pragma omp parallel for schedule(dynamic, 1)  // num_threads(1)
    ...
    */
    std::cout << std::setw(6) << L << std::setw(12) << qps << std::setw(16)
              << mean_latency << std::setw(16) << latency_90 << std::setw(16)
              << latency_95 << std::setw(16) << latency_99 << std::setw(16)
              << latency_999 << std::setw(16) << mean_ios << std::setw(16)
              << mean_recall << std::setw(16) << mean_cpuus << std::endl;
    delete[] stats;
  }
...
void run_index_merger(const char                     *disk_in,
  ...
  diskann::IndexMerger<T, uint32_t> merger(
      disk_in, mem_in, disk_out, deleted_tags, ndims, dist, beam_width, range,
      l_index, alpha, maxc);
